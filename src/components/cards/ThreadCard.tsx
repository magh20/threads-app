...
const ThreadCard = ({id, currentUserId, parentId, content, author, community, createdAt, comments, isComment} : Props) => {
    ...
    return(
        <article className={` flex w-full flex-col rounded-xl ${isComment ? "px-0 py-2 xs:px-7" : "bg-dark-2 p-7"}`}>
            <div className="flex items-start justify-between">
                <div className="flex w-full flex-1 flex-row gap-4">
                    ...
                    <div className="flex w-full flex-col">
                        ...
                        <div className={`${isComment && "mb-2"} flex flex-col gap-3 mt-5`}>
            ...
            {!isComment && community ? (
                ...
                <p className=" text-subtle-medium text-gray-1 mt-3 ml-4">
